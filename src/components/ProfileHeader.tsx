...
const ProfileHeader = ({ user }: { user: UserResource | null | undefined }) => {
  if (!user) return null;
  return (
    <div className="mb-10 relative backdrop-blur-sm border border-border p-6 bg-card">
      <CornerElements />
        ...
        <div className="flex-1">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-2">
            <h1 className="text-3xl font-bold tracking-tight">
              <span className="text-background">{user.fullName}</span>
            </h1>
            <div className="flex items-center backdrop-blur-sm border border-primary rounded px-3 py-1">
          ...
          <div className="h-px w-full bg-primary my-2"></div>
